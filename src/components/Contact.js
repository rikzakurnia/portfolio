...
function Contact() {
  ...
  return (
    <div>
      ...
      <h2 className="text-md text-center mb-6">After filling this form, i will receive an email with the information you fill, so make sure your email is correct so I can send you a reply</h2>
