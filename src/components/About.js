...
const About = () => {
  ...
  return (
    <motion.div
      className="container mx-auto p-8 ml-5" 
    ...
    >
      <div className="flex flex-col md:flex-row items-center">
        <motion.div
          ...
          variants={containerVariants}
        >
          <motion.p className="text-green-500 font-bold text-sm md:text-base" variants={itemVariants}>
            Hello Everyone, My name is
          </motion.p>
          <motion.h1 className="text-3xl md:text-5xl font-bold mb-2" variants={itemVariants}>
        ...
        >
          <motion.img
            ...
            alt="Profile"
            className="w-48 h-48 md:w-54 md:h-54 lg:w-64 lg:h-64 rounded-full"
          />
        </motion.div>
      </div>
      ...
      <div className="flex flex-col md:flex-row mt-5">
        ...
        <motion.div
          className="md:w-1/2 text-center flex flex-col justify-start p-10 md:text-left mt-8 md:mt-0"
          variants={containerVariants} 
        >
          <motion.h4 className="text-xl md:text-2xl text-center font-bold mb-2" variants={itemVariants}>
            Let's connect!
          </motion.h4>
          <motion.div
            className="flex flex-row justify-center self-center md:justify-start"
            variants={containerVariants} 
          >
            <motion.a
              href="https://linkedin.com/in/rikza-kurnia-almujtaba-lubis-058a12226"
              className="flex h-10 w-10 mr-3 items-center justify-center text-slate-200 hover:opacity-75 transition-opacity duration-200"
            ...
            <motion.a
              href="https://github.com/rikzakurnia"
              className="flex h-10 w-10 mr-3 items-center justify-center text-slate-200 hover:opacity-75 transition-opacity duration-200"
              variants={socialIconVariants}
              aria-label="GitHub"
            >
            ...
            <motion.a
              href="https://www.instagram.com/rikzakalmujtaba/"
              className="flex h-10 w-10 mr-3 items-center justify-center text-slate-200 hover:opacity-75 transition-opacity duration-200"
              variants={socialIconVariants}
