  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {blogData.map(blog => (
          <div key={blog.id} className="bg-white rounded-lg shadow-md p-5 mx-2 my-2 overflow-hidden hover:scale-105">
            ...
            <div className="p-4">
              ...
              <a href={blog.link} className="rounded-lg self-end bg-gray-500 py-2 px-4 text-sm font-medium text-white align-end hover:opacity-80">Baca Selengkapnya</a>
            </div>
          </div>
        ))}
      </div>
